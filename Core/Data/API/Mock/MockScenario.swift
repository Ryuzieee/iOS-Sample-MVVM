...
enum MockScenario: Equatable, Identifiable {
    ...
    var id: String {
        ...
        case .customError(let code, _, _): return "error-\(code)"
        }
    }
    ...
    static let forceUpdate = MockScenario.customError(code: 426, message: "Upgrade Required", storeUrl: "https://apps.apple.com")
